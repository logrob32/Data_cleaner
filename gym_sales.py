...
Original file is located at
    https://colab.research.google.com/drive/1dNWWrX0zPBeAlKV9IWADPgSYWIpVy2oJ
"""
...
#I like being able to see all the columns
...
#For actual data purposes
yvc= 50

#For file retrieval, use your downloads folder
downloads = "/Users/lroberts/Downloads/"

#Use the file name of the raw data
data = "Hernando Raw.csv"

#Read in the data
try:
    df = pd.read_csv(f'{downloads}{data}', dtype={'Tab Name': str, 'Phone': str}, encoding='cp1252')
    print("not UTF8")
except UnicodeDecodeError:
    df = pd.read_csv(f'{downloads}{data}', dtype={'Tab Name': str, 'Phone': str})
    print("Is UTF8")
...
#This creates a name for the file based on the initial input
name = f'{downloads}{location}_clean_{today}.csv'
name

#Exporting the file
final.to_csv(f'{name}', index=False)
